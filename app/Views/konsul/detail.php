        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Hasil Konsultasi : <?php echo "<table><tbody><tr><td><textarea rows=\"10\" cols=\"130\" >" . $konsul['hasil_konsul'] . "</textarea></td></tr></tbody></table>"; ?> </p>
                    <p class="card-text">Catatan Konsultasi : <?php echo "<table><tbody><tr><td><textarea rows=\"10\" cols=\"130\" >" . $konsul['catatan_konsul'] . "</textarea></td></tr></tbody></table>"; ?> </p>
