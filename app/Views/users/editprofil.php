...
<div class="container">
    <!-- <div class="row"> -->
    <!-- <div class="col-8"> -->
    <h2 class="my-3">Ubah Data Profl</h2>
    <form action="/users/updateprofil/<?= $session->get('id') ?>" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" id=" nama" name="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid'
                                                                                    : ''; ?>" value="<?= (old('nama')) ? old('nama') : $session->get('nama') ?>">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid'
                                                            : ''; ?>" value="<?= (old('username')) ? old('username') : $session->get('username') ?>" id="username" name="username">
                <div id="validationServer03Feedback" class="invalid-feedback">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('password')) ? 'is-invalid'
                                                            : ''; ?>" value="<?= (old('password')) ? old('password') : $session->get('password') ?>" id="password" name="password">
                <div id="validationServer03Feedback" class="invalid-feedback">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="notelp" name="notelp" value="<?= (old('notelp')) ? old('notelp') : $session->get('notelp') ?>">
            </div>
        </div>
